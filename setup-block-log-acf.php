...
function ss_block_acf_init() {
    ...
    $blocks = array(
        ...
        'logs' => array(
    		'name'			    => 'log',
    		'title'			    => __('Log'),
    		'render_template'	=> plugin_dir_path( __FILE__ ).'partials/blocks/block-log-setup-starter.php',
        ...
        'feature' => array(
            ...
            'title'             => __('Feature'),
            'render_template'   => plugin_dir_path( __FILE__ ).'partials/blocks/block-feature-setup-starter.php',
            'category'          => 'setup_starter',
            'icon'              => 'list-view',
            'mode'              => 'edit',
